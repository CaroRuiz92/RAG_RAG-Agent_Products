# Manual Técnico - Deluxe Cafetera 2024

**Modelo:** P0120 | **Marca:** HomeChef
...
- **Modelo:** P0120
- **Nombre Comercial:** Deluxe Cafetera 2024
...
### Bomba de Presión 15 Bar
**Código:** `BOM-P0120-001`

Bomba italiana de alta presión para extracción profesional de espresso. Caudal: 1.2 L/min. Nivel de ruido: <70dB.

### Caldera de Acero Inoxidable
**Código:** `CAL-P0120-002`

Caldera termoblock de 1400W. Alcanza temperatura óptima (92-96°C) en 45 segundos. Capacidad: 1.5L.

### Grupo de Extracción
**Código:** `GRU-P0120-003`

Cabezal de extracción cromado. Compatible con portafiltros de 58mm. Sistema de pre-infusión integrado.

### Vaporizador Profesional
**Código:** `VAP-P0120-004`

Lanza de vapor 360° para texturizar leche. Potencia: 1200W. Produce micro-espuma cremosa en 30-40 segundos.

## Procedimientos de Uso

### PROCEDIMIENTO 1: Preparar Café Espresso

**Dificultad:** Medio-Alto | **Tiempo:** 8-10 minutos

**Pasos:**

1. Llenar el tanque de agua con agua filtrada fría
2. Precalentar la máquina encendiéndola 5-10 minutos antes
3. Moler café en grano (14-18g para espresso doble)
4. Llenar el portafiltro con café molido
5. Nivelar el café con el dedo sin comprimir aún
6. Usar el tamper para comprimir con 15kg de presión
7. La superficie debe quedar lisa y uniforme
8. Limpiar los bordes del portafiltro de restos de café
9. Insertar el portafiltro en el grupo con giro firme
10. Colocar taza(s) precalentadas bajo las salidas
11. Iniciar extracción inmediatamente (café fresco)
12. El espresso debe fluir como 'miel' en 25-30 segundos
13. Detener cuando alcance 30ml (simple) o 60ml (doble)
14. Retirar las tazas y servir inmediatamente
15. Desechar el café usado y enjuagar el portafiltro
...
- **Eco Waflera** (`P0065`)
  - Comparte: Motor
- **Turbo Conservadora** (`P0106`)
  - Comparte: Motor
- **Premium Cafetera** (`P0121`)
  - Comparte: Motor
...
*Documento generado: P0120 - Deluxe Cafetera 2024*
